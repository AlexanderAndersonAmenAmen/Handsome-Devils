return {
	...
	misc = {
		dictionary = {
			...
			hnds_devil_name_legion = "El Diablo",
			hnds_devil_name_old_nick = "El Diablo",
			hnds_devil_name_deceiver = "El Diablo",
			hnds_devil_name_tempter = "El Diablo",
			hnds_devil_name_adversary = "El Diablo",
			hnds_devil_name_prince_of_darkness = "El Diablo",
			hnds_devil_name_belial = "El Diablo",
			hnds_devil_name_apollyon = "El Diablo",
			hnds_devil_name_lucifer = "El Diablo",
			hnds_devil_name_abaddon = "El Diablo",
			hnds_devil_name_leviathan = "El Diablo",

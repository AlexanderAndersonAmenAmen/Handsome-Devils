return {
	...
	misc = {
		dictionary = {
			...
			hnds_devil_name_legion = "Legión",
			hnds_devil_name_old_nick = "Viejo Nick",
			hnds_devil_name_deceiver = "El Engañador",
			hnds_devil_name_tempter = "El Tentador",
			hnds_devil_name_adversary = "El Adversario",
			hnds_devil_name_prince_of_darkness = "Príncipe de las Tinieblas",

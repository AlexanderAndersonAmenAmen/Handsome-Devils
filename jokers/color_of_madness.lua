...
SMODS.Joker({
	...
	unlocked = false,
	discovered = false,
	unlock_condition = { type = "hnds_joker_unlock", key = "color_of_madness" },
	locked_loc_vars = function(self)
	    return HNDS.joker_locked_loc_vars("color_of_madness")
	end,
	check_for_unlock = function(self, args)
	    return HNDS.joker_unlock_condition_met("color_of_madness", args)
	end,

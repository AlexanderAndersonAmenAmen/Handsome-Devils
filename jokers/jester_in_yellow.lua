SMODS.Joker({
	...
	unlocked = false,
	discovered = false,
	unlock_condition = { type = "hnds_joker_unlock", key = "jester_in_yellow" },
	locked_loc_vars = function(self)
	    return HNDS.joker_locked_loc_vars("jester_in_yellow")
	end,
	check_for_unlock = function(self, args)
	    return HNDS.joker_unlock_condition_met("jester_in_yellow", args)
	end,

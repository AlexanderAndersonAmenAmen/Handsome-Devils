SMODS.Joker {
    ...
    unlocked = false,
    discovered = false,
    unlock_condition = { type = "hnds_joker_unlock", key = "time_fcked_joker" },
    locked_loc_vars = function(self)
        return HNDS.joker_locked_loc_vars("time_fcked_joker")
    end,
    check_for_unlock = function(self, args)
        return HNDS.joker_unlock_condition_met("time_fcked_joker", args)
    end,
